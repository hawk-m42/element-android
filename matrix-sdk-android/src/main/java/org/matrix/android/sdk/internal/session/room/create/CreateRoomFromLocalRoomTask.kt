...
/**
 * Create a Room from a local room.
...
internal class DefaultCreateRoomFromLocalRoomTask @Inject constructor(
        ...
        private val getCreateRoomParamsFromLocalRoomTask: GetCreateRoomParamsFromLocalRoomTask,
    ...
    override suspend fun execute(params: CreateRoomFromLocalRoomTask.Params): String {
        ...
        val createRoomParams = getCreateRoomParamsFromLocalRoomTask.execute(GetCreateRoomParamsFromLocalRoomTask.Params(params.localRoomId))
